...
class LQRController(AbstractController):
    ...
    def init_(self):
        ...
        """
        self.Alin, self.Blin = self.splant.linear_matrices(x0=self.xd, u0=[0.0, 0.0])
        self.K, self.S, _ = lqr(self.Alin, self.Blin, self.Q, self.R)
...
class LQRController_nonsymbolic(AbstractController):
    ...
    def init_(self):
        ...
        Initalize the controller.
        """
        self.Alin, self.Blin = self.plant.linear_matrices(x0=self.xd, u0=[0.0, 0.0])
        self.K, self.S, _ = lqr(self.Alin, self.Blin, self.Q, self.R)
